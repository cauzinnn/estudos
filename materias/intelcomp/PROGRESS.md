...
3. **0003 - Busca com Retrocesso (Backtracking Search)** — ⏳ *Próxima*
...
- [ ] **Subotimalidade da DFS:** Pode encontrar um caminho profundo e custoso antes de avaliar opções rasas.
- [ ] **Incompletude em Árvore com Ciclos (DFS):** Sem registro de nós visitados (busca em grafo), a DFS entra em loop infinito.
